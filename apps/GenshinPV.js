...
export class GenshinPV extends plugin {
  ...
  async gcdh(e) {
    let url2 =
      'https://api-static.mihoyo.com/common/blackboard/ys_obc/v1/home/content/list?app_sn=ys_obc&channel_id=80';
...
async function SendMusicShare(e, data, to_uin = null) {
  ...
  switch (data.source) {
    case 'mys':
      ((appid = 1109288517),
        (appname = 'com.mihoyo.hyperion'),
        (appsign = 'abdcfbc2380da2413c1e0be7a118dd9e'));
      break;
    case 'netease':
      ((appid = 100495085),
